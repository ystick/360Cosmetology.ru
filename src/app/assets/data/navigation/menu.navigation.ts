import { ABONEMENTS_LINK, ABOUT_US_LINK, ACTIONS_LINK, BLOG_LINK, CONTACTS_LINK, Link, NEWS_LINK, RESULTS_LINK_FOTO, SERVICES_PRICING_LINK, STAFF_LINK } from '@constants/route.constants'
