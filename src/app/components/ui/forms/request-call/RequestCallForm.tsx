...
import { IRequestCallForm } from '@interfaces'
...
export const RequestCallForm: FC = () => {
  ...
  const {
    ...
    control,
    formState: { errors }
  } = useForm<IRequestCallForm>()

  const onSubmit: SubmitHandler<IRequestCallForm> = async (data) => {
    setTokenError(null)
    setLoading(false)
  ...
  return (
    <>
      <div className='mb-[14px]'>
        <p className='text-tertiary font-bold text-[32px]/[32px] text-center'> Перезвоните мне</p>
      </div>
      <div className='mb-8'>
